        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-blue-100 text-lg">Welcome back, <span className="font-semibold">{JSON.parse(localStorage.getItem('adminUser') || '{}').username}</span></p>
            </div>
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="bg-green-50 px-3 py-1 rounded-full">
                  <span className="text-green-600 text-sm font-bold">{stat.trend}</span>
                </div>
              </div>
              <h3 className="text-gray-500 text-sm font-semibold uppercase tracking-wide mb-2">{stat.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {quickActions.map((action, index) => (
              ...
              >
                ...
                >
                  <div className={`${action.color} w-14 h-14 rounded-xl flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition-transform`}>
                    <action.icon className="w-7 h-7 text-white" />
                  </div>
                  <h3 className="font-bold text-gray-900 mb-2 text-lg group-hover:text-blue-600 transition-colors">{action.title}</h3>
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 border border-gray-100">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-xs bg-blue-100 text-blue-700 px-3 py-1 rounded-full font-semibold">LIVE</span>
          </div>
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-5 bg-gradient-to-r from-blue-50 to-transparent rounded-xl border-l-4 border-blue-500 hover:shadow-md transition-shadow">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">Tesla Model 3 • 2 hours ago</p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-5 bg-gradient-to-r from-green-50 to-transparent rounded-xl border-l-4 border-green-500 hover:shadow-md transition-shadow">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">Home page banner • 5 hours ago</p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-5 bg-gradient-to-r from-purple-50 to-transparent rounded-xl border-l-4 border-purple-500 hover:shadow-md transition-shadow">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">File upload enabled • 1 day ago</p>
              </div>
            </div>
          </div>
        </div>
