...
-- This script sets up all tables for the Car Dealership application
-- Note: Railway database is named 'railway' by default
...
-- Populate vehicle_images table with primary images from vehicles
